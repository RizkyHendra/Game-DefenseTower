...
public class Tower : MonoBehaviour
{
    ...
    // untuk digunakana menyimpan posisi yang akan ditempati selama tower di drag
    ...
    // Untuk mengubah order in layer pada tower yang sedang di drag
