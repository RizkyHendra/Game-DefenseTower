...
public class Bullet : MonoBehaviour
{
    ...
    // uNTUK FixedUpdate adalah update yang lebih konsisten jeda pemanggilannya
    // Untuk cocok digunakan jika karakter memiliki Physic (Rigidbody, dll)
